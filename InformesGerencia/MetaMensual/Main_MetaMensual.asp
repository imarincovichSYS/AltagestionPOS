...
<%
    if  session("login")="7001569" or session("login")="9817604" or session("login")="182015725" or session("login")="10948121" or session("login") = "16964103" or session("login") = "18201572" then
      jlinea = "true"
    else
      jlinea = "false"
    end if
