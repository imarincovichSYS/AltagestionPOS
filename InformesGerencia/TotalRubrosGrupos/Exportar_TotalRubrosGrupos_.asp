<%
    ...
    if servidor = "R169" then strConnect = "DSN=AG_Sanchez_R15; UID=AG_Sanchez; PWD=; APP=" & APP & ";WSID=" & WSID & ";DATABASE=Sanchez; LANGUAGE=Spanish;"
    if servidor = "R15" then strConnect = "DSN=AG_Sanchez_R169; UID=AG_Sanchez; PWD=; APP=" & APP & ";WSID=" & WSID & ";DATABASE=Sanchez; LANGUAGE=Spanish;"
...
<%      do while not rs.eof %>
            ...
            <td Align='center'><% = rs( "QMerc" ) %></td>

            <td Align='right' class='FormatNumber_0'><% = FormatNumber( rs( "Total_$" ), 0 ) %></td>
            <td Align='right' class='FormatNumber_0'><% = FormatNumber( rs( "Neto_$" ), 0 ) %></td>
