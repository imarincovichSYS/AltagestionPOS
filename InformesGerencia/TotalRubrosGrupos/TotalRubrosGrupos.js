function Mostrar_TotalRubrosGrupos(v_async, v_busqueda_aprox, jlinea) {
    ...
    var ajx = new Ajax("Mostrar_TotalRubrosGrupos.asp", {
        method: 'post',
        async: eval(v_async),
        ...
        onComplete: function (respuesta) {
            ...
            if (respuesta == "")
                Cancelar_TotalRubrosGrupos(jlinea)
            else {
                if (jlinea) {
...
function Exportar_TotalRubrosGrupos() {
    par = 'Fecha_desde=' + Fecha_desde.value;
    servidor = Servidor.value;
    par += '&servidor=' + servidor;
    //alert(par);
    if (servidor == "P") { ruta_informe = "Exportar_TotalRubrosGrupos"; }
    if (servidor == "Replica") { ruta_informe = "Exportar_TotalRubrosGrupos"; }
    if (servidor == "Test") { ruta_informe = "Exportar_TotalRubrosGrupos"; }
    //alert(ruta_informe);
...
function Cancelar_TotalRubrosGrupos(jlinea) {
