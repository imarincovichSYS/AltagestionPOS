...
<html>
    <head>
        ...
        <script language="javascript" src="TotalRubrosGrupos.js"></script>
    </head>
<%
            ...
            <tr align="center">
                <td>
                    <table width="100%" cellPadding="0" cellSpacing="0" align="center" border=0>
                        <tr bgcolor="#444444">
                            <td align="center" style="font-size: 11px; color:#FFFFFF;"><b><label id="label_accion_modulo" name="label_accion_modulo">TOTALES por RUBRO por GRUPO</label></font></b></td>
                    ...
                    <table id="tabla_botonera_general" name="tabla_botonera_general" width="100%" align="center" cellPadding="0" cellSpacing="0" border=0>
                        <tr id="texto_11" height="30" bgcolor="#DDDDDD">
                            ...
                            <%end if%>
                                ...
                                <input class="boton_Buscar_on" type="button" title="Mostrar informe" OnClick="Mostrar_TotalRubrosGrupos(true,1,false)" id="bot_buscar" name="bot_buscar" style='display: none;'>&nbsp; 
                                <input class="boton_Excel_off" type="button" title="Exportar informe a Excel" OnClick="Exportar_TotalRubrosGrupos()" id="bot_excel" name="bot_excel">&nbsp;
    
                            <%if jlinea="false" then%>
                                <!-- <input class="boton_Atras_off" type="button" title="Ir atrás" disabled OnClick="Cancelar_TotalRubrosGrupos(false)" id="bot_atras" name="bot_atras"> -->
                            <%else%>
                                <!-- <input class="boton_Atras_off" type="button" title="Ir atrás" disabled OnClick="Cancelar_TotalRubrosGrupos(true)" id="bot_atras" name="bot_atras"> -->
                            <%end if%>
                            </td>
