...
<html>
    <head>
        ...
        <script language="javascript" src="Metas.js"></script>
    </head>
<%
    if  session("login")="7001569" or session("login")="9817604" or session("login")="182015725" or session("login")="10948121" then
      jlinea = "true"
    else
      jlinea = "false"
    end if
            ...
            <tr align="center">
                <td>
                    <table width="100%" cellPadding="0" cellSpacing="0" align="center" border=0>
                        <tr bgcolor="#444444">
                            <td align="center" style="font-size: 11px; color:#FFFFFF;"><b><label id="label_accion_modulo" name="label_accion_modulo">METAS MENSUAL</label></font></b></td>
                        ...
                        <tr id="texto_11" height="30" bgcolor="#DDDDDD">
                            <td id="td_cab_4" name="td_cab_4" width="140">&nbsp;<b>Servidor:</b>
                                <select id='Servidor'>
                                    ...
                                    <% if jlinea="true" then %>
                                       <!-- <option value='R169'>Replica 169</option>  -->
                                    <option value='R16'>Replica 16</option>
                                    <% end if %>
                                </select>
                            ...
                            <%end if%>
                                ...
                                <input class="boton_Buscar_on" type="button" title="Mostrar metas" OnClick="Mostrar_Metas(true,1,false)" id="bot_buscar" name="bot_buscar" style='display: none;'>&nbsp; 
                                <input class="boton_Excel_off" type="button" title="Exportar metas a Excel" OnClick="Exportar_Metas()" id="bot_excel" name="bot_excel">&nbsp;
    
                            <%if jlinea="false" then%>
                                <!-- <input class="boton_Atras_off" type="button" title="Ir atrás" disabled OnClick="Cancelar_Metas(false)" id="bot_atras" name="bot_atras"> -->
                            <%else%>
                                <!-- <input class="boton_Atras_off" type="button" title="Ir atrás" disabled OnClick="Cancelar_Metas(true)" id="bot_atras" name="bot_atras"> -->
                            <%end if%>
                            </td>
