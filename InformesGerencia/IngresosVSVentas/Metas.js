function Mostrar_Metas(v_async, v_busqueda_aprox, jlinea) {
    strCargando = "<br><br><center><img src='" + RutaProyecto + "imagenes/new_loader.gif' width='32' height='32' "
    strCargando += "border='0' align='top'><br><br><font color='#848284'><b>Buscando metas...</b></font><br><br></center>"
    ...
    var ajx = new Ajax("Mostrar_Metas.asp", {
        method: 'post',
        async: eval(v_async),
...
function Exportar_Metas() {
    par = 'Fecha_desde=' + Fecha_desde.value;
	servidor = Servidor.value;
	par += '&servidor=' + servidor;
	//alert(par);
	if (servidor == "P") {ruta_informe = "Exportar_Metas";}
	if (servidor == "R169") {ruta_informe = "Exportar_Metas";}
	if (servidor == "R16") {ruta_informe = "Exportar_Metas";}
	//alert(ruta_informe);
...
function Cancelar_Metas(jlinea) {
