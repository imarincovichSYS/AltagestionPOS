<%
    ' http://s02sys.sys.local/altagestion/InformesGerencia/MetaMensual/Exportar_Metas.asp?servidor=P
    ' http://192.168.30.10/Abonados/Sanchez_PtaArenas/InformesGerencia/MetaMensual/Exportar_Metas.asp?servidor=P
    ...
    if servidor = "R16" then strConnect = "DSN=AG_Sanchez_R16; UID=AG_Sanchez; PWD=; APP=" & APP & ";WSID=" & WSID & ";DATABASE=Sanchez; LANGUAGE=Spanish;"
    ...
    if not rs.eof then
        ...
        strHTML = strHTML  & "<tr style='font-family: Arial; font-size: 9px;'>"
		'-- A, B
        ...
        strHTML = strHTML  & "<td Align='center' colspan='5'><B>Tránsito (US$)</B></td>"
        strHTML = strHTML  & "<td Align='center' colspan='2'><B>(US$)</B></td>"
        strHTML = strHTML  & "<td Align='center' colspan='3'><B>Q. Merc</B></td>"
        strHTML = strHTML  & "<td Align='center' colspan='3'><B>Líneas</B></td>"
        ...
        do while not rs.eof
            ...
            do while saveGrupo = rs( "Grupo" )
                ...
                strHTML = strHTML & "<td Align='right' class='FormatNumber_2'>" & FormatNumber( rs( "Tto_Mes_Ant" ), 2 ) & "</td>"
                strHTML = strHTML & "<td Align='right' class='FormatNumber_2'>" & FormatNumber( rs( "Tto_Mes" ), 2 ) & "</td>"
                strHTML = strHTML & "<td Align='right' class='FormatNumber_2'>" & FormatNumber( rs( "Tto_Mes_1" ), 2 ) & "</td>"
                strHTML = strHTML & "<td Align='right' class='FormatNumber_2'>" & FormatNumber( rs( "Tto_Mes_2" ), 2 ) & "</td>"
                strHTML = strHTML & "<td Align='right' class='FormatNumber_2'>" & FormatNumber( rs( "Tto_Fut" ), 2 ) & "</td>"
            ...
            strHTML = strHTML & "<td Align='right' class='FormatNumber_2'>" & FormatNumber( Tto_Mes_A, 2 ) & "</td>"
            strHTML = strHTML & "<td Align='right' class='FormatNumber_2'>" & FormatNumber( Tto_Mes_0, 2 ) & "</td>"
            strHTML = strHTML & "<td Align='right' class='FormatNumber_2'>" & FormatNumber( Tto_Mes_1, 2 ) & "</td>"
            strHTML = strHTML & "<td Align='right' class='FormatNumber_2'>" & FormatNumber( Tto_Mes_2, 2 ) & "</td>"
            strHTML = strHTML & "<td Align='right' class='FormatNumber_2'>" & FormatNumber( Tto_Fut, 2 ) & "</td>"
        ...
        strHTML = strHTML & "<td Align='right' class='FormatNumber_2'>" & FormatNumber( tTto_Mes_A, 2 ) & "</td>"
        strHTML = strHTML & "<td Align='right' class='FormatNumber_2'>" & FormatNumber( tTto_Mes_0, 2 ) & "</td>"
        strHTML = strHTML & "<td Align='right' class='FormatNumber_2'>" & FormatNumber( tTto_Mes_1, 2 ) & "</td>"
        strHTML = strHTML & "<td Align='right' class='FormatNumber_2'>" & FormatNumber( tTto_Mes_2, 2 ) & "</td>"
        strHTML = strHTML & "<td Align='right' class='FormatNumber_2'>" & FormatNumber( tTto_Fut, 2 ) & "</td>"
