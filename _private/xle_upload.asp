...
Class xelUpload
   ...
   Public Sub BorrarFichero(nombrefichero, ruta)
      ...
      fs.DeleteFile ruta & nombrefichero, True
   End Sub
   
   Public Function ExisteFichero(nombrefichero, ruta)
      ExisteFichero = false
      if ruta = "" or nombrefichero = "" then Exit Function
      if Mid(ruta, Len(ruta)) <> "\" then		'"	
      	'añado la ultima barra a la ruta
      	ruta = ruta & "\" 						'"
      end if      
      set oFSO = Server.CreateObject("Scripting.FileSystemObject")
      ExisteFichero = oFSO.FileExists(ruta & nombrefichero)
   End Function   
End Class
