...
<div id="capaDatosCompra" name="capaDatosCompra" style="position:absolute; width: <%=w_fieldset%>px; top: 22px; z-index:-1; visibility:hidden; background-color:#FFFFFF;">
  <fieldset id="fieldset_datos_generales" name="fieldset_datos_generales" align="center" style="width:<%=w_fieldset-8%>px;; height:62px; padding: 0px; padding-left: 2px;">
    ...
    <tr id="tr_cab_1" name="tr_cab_1" height="22">
      ...
      <td style="width:178px; font-size:10px;">&nbsp;<b>AÑO:</b>
      ...
      <td id="td_cab_1_1" name="td_cab_1_1" width="86" align="right"><b>FEC. ADUANA:</b>&nbsp;</td>
      ...
      onmouseup="return false;"
      type="text" id="fecha_emision" name="fecha_emision" maxlength="10" style="width: 60px;"></td>
      <td id="td_cab_1_3" name="td_cab_1_3" width="76" align="right"><b>FEC. RECEP.:</b>&nbsp;</td>
    ...
    <tr id="tr_cab_2" name="tr_cab_2" style="height:30px;">
      <td id="td_cab_2_1" name="td_cab_2_1" align="left">&nbsp;<b>FEC. FACTURA:</b>
      <input o_value=""
      onfocus="select();"
      ...
      <td id="td_cab_2_2" name="td_cab_2_2" align="right"><b>N° FACTURA:</b>&nbsp;</td>
