...
num_linea_inicial     = Request.Form("num_linea_inicial")
num_linea_final       = Request.Form("num_linea_final")
...
elseif accion = "update" then
  ...
  strSQL="update " & nom_tabla & " set " &_
         ...
         "num_linea_inicial     = "   & num_linea_inicial & ", " &_
         "num_linea_final       = "   & num_linea_final & " " &_
