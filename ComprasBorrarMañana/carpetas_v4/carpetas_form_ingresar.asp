...
strMes        = GetMes(mes)
strSQL="select id_embarcador, id_transporte, id_origen, IsNull(fecha_salida,'') as fecha_salida, IsNull(fecha_llegada,'') as fecha_llegada, " &_
       "manifiesto, tipo_moneda, contenedor1, contenedor2 " &_
...
if not rs.EOF then
  ...
  tipo_moneda   = rs("tipo_moneda")
  contenedor1   = rs("contenedor1")
  contenedor2   = rs("contenedor2")
end if
...
<tr>
  ...
  <fieldset id="fieldset_datos_generales" name="fieldset_datos_generales" align="center" style="width:1220px; height:100px;">
    ...
    <tr style="height:44px; color:#555;">
      ...
      <td style="width:158px;"><b>ORIGEN</b><br>
      ...
      <td style="width:146px;"><b>TRANSP.</b><br>
      ...
      <td style="width:140px;"><b>FEC. SALIDA</b><br>
      ...
      <td style="width:140px;"><b>FEC. LLEGADA</b><br>
      ...
      <td style="width:140px;"><b>MANIFIESTO</b><br>
      <input value="<%=manifiesto%>" o_value="<%=manifiesto%>" tipo_dato="texto" type="text" id="manifiesto" name="manifiesto" maxlength="10" style="width: 64px;"></td>
      <td><b>EMBARCADOR</b><br>
    ...
    <tr style="height:44px; color:#555;">
      <td>&nbsp;</td>
      <td colspan=2><b>MON. ORI.</b><br>
      <select id="tipo_moneda" name="tipo_moneda" style="width: 90px;" tipo_dato="texto" o_value="<%=tipo_moneda%>">
        <option value=""></option>
      ...
      <td colspan=2"><b>N° CONTENEDOR (1)</b><br>
      <input value="<%=contenedor1%>" o_value="<%=contenedor1%>" tipo_dato="texto" type="text" id="contenedor1" name="contenedor1" maxlength="20" style="width: 110px;"></td>
      <td><b>N° CONTENEDOR (2)</b><br>
      <input value="<%=contenedor2%>" o_value="<%=contenedor2%>" tipo_dato="texto" type="text" id="contenedor2" name="contenedor2" maxlength="20" style="width: 110px;"></td>
    </tr>
    </table>
  </fieldset>
  <fieldset id="fieldset_gastos" name="fieldset_gastos" align="center" style="width:1220px; height:450px;">
