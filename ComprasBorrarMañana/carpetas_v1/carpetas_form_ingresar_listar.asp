...
strSQL="select A.numero_linea, A.entidad_comercial, " &_
       ...
       "A.id_tipo_factura, A.numero_factura, A.tipo_moneda, A.monto_moneda_origen, A.paridad, A.monto_total_us$, A.monto_final_us$, A.porcentaje_prorrateo " &_
...
if not rs.EOF then
  ...
  <tr>
    ...
    <tr valign="top" height="16">
      ...
      <td style="width:<%=w_monto_fin_usd%>px; text-align:center;"  id='grid_TH_1'>Monto Final<br>US$</td>
