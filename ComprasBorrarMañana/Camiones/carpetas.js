...
function Generar_Informe(v_numero_documento_respaldo,v_documento_no_valorizado,v_documento_respaldo,v_fecha_recepcion,v_proveedor, v_nombre_proveedor,v_fecha_emision,v_paridad,v_total_cif_ori,v_total_cif_adu,v_carpeta, v_fecha_factura){
	if (v_fecha_factura == undefined) {v_fecha_factura = v_fecha_emision;}
  ...
  parametros+="&fecha_factura="+v_fecha_factura
  ruta_informe = "../../ComprasNew/compras_listar_detalle.asp?"+parametros  
  ...
  WinInforme = open(ruta_informe, "Inf", str, "replace=1")
}
