...
function Set_CODPROV(v_proveedor,v_id_input){
  var ajx = new Ajax(RutaProyecto+"compras/compras_proveedor_get_codprov.asp",{
    method:'post', 
    async:false,
    evalScripts:true,
...
function Cargar_Datos_Proveedor(){
  var ajx = new Ajax(RutaProyecto+"compras/compras_proveedor_datos.asp",{
    method:'post', 
    async:false,
...
function Verificar_Proveedor(){
  ...
  entidad_comercial.disabled  = true
  var ajx = new Ajax(RutaProyecto+"compras/compras_proveedor_verificar.asp",{
    method:'post', 
    async:false,
    ...
    onComplete: function(respuesta){
      ...
      else
      {
        ...
        {
          var ajx1 = new Ajax(RutaProyecto+"compras/compras_proveedor_grabar.asp",{
            method:'post', 
            async:false,            
...
function Ingresar_Datos_Proveedor(){
  ...
  grilla_productos.innerHTML  = ""
  var ajx10 = new Ajax(RutaProyecto+"compras/compras_oveedor_grilla.asp",{
    method:'post', 
    data: 'entidad_comercial='+entidad_comercial.value,
    update:$("grilla_nuevo"),
    evalScripts:true,
...
function SaveChanges(cell, c_row, c_col, c_type, c_name, c_scale, c_maxlength, c_null){
  ...
  v_url           = RutaProyecto+"compras/pedidos/pedidos_productos_grabar.asp"
  v_num_linea     = eval("document.all.celda_" + c_row + "_" + C_ITEMS).value
  if(nom_tabla=="entidades_comerciales")
    v_url = RutaProyecto+"compras/compras_proveedor_grabar.asp"
  document.body.style.cursor="wait"  
