...
if accion = "NUEVO" then
  ...
  for i=1 to items
    ...
    strSQL="insert into "&nom_tabla&"(Año_recepcion_compra,Bodega, cantidad_mercancias, " &_
           ...
           "Cantidad_x_caja, Peso_x_caja, Delta_CPA_US$, unidad_de_medida_origen, cantidad_origen) values(" &_
           ""&anio&"," &_
           "'"&bodega&"'," &_
           "0,1,0," &_
           "'"&v_proveedor&"'," &_
...
if documento_no_valorizado = "TCP" then
  ...
  if vista = "NORMAL" then
    strSQL="select '', A.numero_de_linea_en_rcp_o_documento_de_compra, A.numero_de_linea_en_rcp_o_documento_de_compra_padre, " &_
           ...
           "numero_guia_de_despacho_o_factura_proveedor, proveedor, IsNull(Codigo_antiguo,'') as Codigo_antiguo, IsNull(codcaja,'') as codcaja from "&nom_tabla&" where empresa='SYS' and documento_no_valorizado='"&documento_no_valorizado&"' and " &_
