...
do while not rs_itemes.EOF
  ...
  'if not rs.eof then
    ...
    'elseif UCASE(mid(Trim(producto),1,1)) = "B" then 
      'destinatarios = "mpinilla@sanchezysanchez.cl,cmoscoso@sanchezysanchez.cl,"
    'elseif UCASE(mid(Trim(producto),1,1)) = "C" or UCASE(mid(Trim(producto),1,1)) = "L" or UCASE(mid(Trim(producto),1,1)) = "M" or UCASE(mid(Trim(producto),1,1)) = "N" or UCASE(mid(Trim(producto),1,1)) = "P" then
   ''   destinatarios = "ofernandez@sanchezysanchez.cl,omorales@sanchezysanchez.cl,"
   '' elseif UCASE(mid(Trim(producto),1,1)) = "D" or UCASE(mid(Trim(producto),1,1)) = "R" then
   ''   destinatarios = "rpinochet@sanchezysanchez.cl,"
  ...
  ''    destinatarios = "joyarzun@sanchezysanchez.cl, acardenas@sanchezysanchez.cl,"
  ...
  ''  elseif UCASE(mid(Trim(producto),1,1)) = "H" or UCASE(mid(Trim(producto),1,1)) = "V" or UCASE(mid(Trim(producto),1,1)) = "S" or UCASE(mid(Trim(producto),1,1)) = "X" then
...
do while not rs.EOF
  cSql = "Exec PRO_CALCULA_STOCK_MIN_2 '" & rs("producto") & "'"
