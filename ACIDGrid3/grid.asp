...
'The Grid
class agrid
	public cols(), recordset, strHTML_options, Cell_borderColor, Table_borderColor, Width, Height, TH_BackgroundColor
	public TH_Color, TH_Height, Title, delimiter, delimiter_select, scroll_Div_Totales, num_grid, tipo_scroll, marcarFilaClickCheckbox
	private cantCols
	...
	private sub class_initialize()			
		...
		num_grid                = "1"
		tTipoScroll             = "1" '1: Scroll completo, 2: Sólo scroll vertical, 3: Sólo scroll horizontal
		marcarFilaClickCheckbox = "0"
	end sub
  ...
  public function getHeaderHeight()
    ...
    s_op_texts  = ""
	    ...
	    g_propietes = g_propietes & delimiter & _
	                   ...
	                   cols(i).getColorCell_Background() & _
	                   cols(i).getColorCell_BorderLeft() & _
	                   cols(i).getColorCell_BorderRight() & _
	                   cols(i).getColorCell_BorderTop() & _
	                   cols(i).getColorCell_BorderBottom() & _
    ...
    strHTML = strHTML & "setTotRows(" & tot_rows & ");" & vbCrlf
		...
		strHTML = strHTML & "setNumGrid(" & num_grid& ");" & vbCrlf
		strHTML = strHTML & "setTipoScroll(" & tipo_scroll& ");" & vbCrlf
		strHTML = strHTML & "setMarcarFilaClickCheckbox(" & marcarFilaClickCheckbox& ");" & vbCrlf
		strHTML = strHTML & "setCantCols(" & cantCols& ");" & vbCrlf
		...
		strHTML = strHTML & "writeInnerHTML(" & num_grid & ");" & vbCrlf
