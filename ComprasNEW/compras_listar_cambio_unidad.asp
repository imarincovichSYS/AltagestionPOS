...
strSQL1="select A.item, A.item_padre, B.cant_c, B.un_c, B.descripcion, B.descripcion_original, B.cif_unitario_c, " &_
        ...
        "Unidad_de_medida_consumo un_v, Round(costo_cif_adu_us$,4) cif_unitario_v from movimientos_productos with(nolock) " &_
        "where empresa='SYS' and documento_no_valorizado='"&documento_no_valorizado&"' and " &_
        "Tipo_documento_de_compra='"&documento_respaldo&"' and " &_
        "convert(varchar(12),fecha_movimiento,111)='"&fecha_recepcion&"' and " &_
...
sub Imprime_Encabezado_Cambio_Unidad()
  ...
  <tr height="26">
    ...
    <td colspan="5" style="border-top:.5pt solid windowtext; border-right:.5pt solid windowtext;">USUARIO DE ZONA FRANCA SANCHEZ Y SANCHEZ SPA</td>
    <td colspan="2" style="border-top:.5pt solid windowtext; border-right:.5pt solid windowtext; " align="center">N&ordm; AUTORIZACION ADUANA</td>
  ...
  <tr height="26">
    <td colspan="5" style="font-family: courier; border-right:.5pt solid windowtext;">GARANTIA N&ordm;470 A&Ntilde;O 2021</td>
  ...
  <tr height="25" align="center">
    ...
    <td style="border-right:.5pt solid windowtext;" colspan="3">N&ordm; Y FECHA DE CONTRATO</td>
...
%>
  ...
  <tr height="15" style="font-size:10px;">
    <td colspan="5" style="border-left:.5pt solid windowtext; border-right:.5pt solid windowtext;"></td>
    <td colspan="7" style="border-right:.5pt solid windowtext;">las mercancias existentes en en el(los) Ítem(s) se&ntilde;alado(s).</td>
...
sub Get_Totales_Compra_Sub_Itemes(v_documento_no_valorizado, v_tipo_documento_de_compra, v_fecha_mov, v_numero_documento_de_compra, v_num_linea_padre)
  strSQL="select IsNull(sum(Round(Round(Cantidad_entrada * Costo_CIF_ADU_US$,2) / cantidad_mercancias,4)),0) total_cif_unitario, " &_
         ...
         "from movimientos_productos with(nolock) where empresa='SYS' and documento_no_valorizado='"&v_documento_no_valorizado&"' and " &_
  ...
  <x:ExcelWorksheets>
   <x:ExcelWorksheet>
    ...
    <x:WorksheetOptions>
     ...
     <!--<x:ShowPageBreakZoom/> --> <!-- Muestra los n�mero de p�gina de Excel -->
