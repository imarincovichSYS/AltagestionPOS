...
numero_interno_carpeta_detalle = Request.Form("numero_interno_carpeta_detalle")
...
elseif accion = "update" then
  ...
  cSQL = "update carpetas_final_detalle set prorrateo = prorrateo,GrupoID = " & GrupoID & " where numero_interno_carpeta_detalle = " & numero_interno_carpeta_detalle 
  set rs = Conn.Execute( cSQL )
