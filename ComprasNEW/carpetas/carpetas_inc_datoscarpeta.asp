...
%>
<div id="capaDatosCarpeta" name="capaDatosCarpeta" style="position:absolute; width: 976px; top: 30px; z-index:-1; visibility:hidden;">
  <fieldset id="fieldset_datos_generales" name="fieldset_datos_generales" align="center" style="width:100%; height:50px;">
    ...
    <tr height="22">
      ...
      onfocus="select();"
      OnKeyUp="SetKey(event);if(key==13)$('fecha_llegada').focus()"
      ...
      <input value="<%=fecha_hoy%>" 
      onfocus="select();"
      OnKeyUp="SetKey(event);if(key==13)$('manifiesto').focus()"
      onblur="this.value=GetFechaCompleta(this.value,'<%=fecha_hoy%>');if(this.value!='')Actualizar_Datos_Carpeta(this.name,this.value)"
      onkeypress="return Valida_Caracteres_Fecha(event);" 
      onclick="displayCalendarEjectFunction(this,'dd/mm/yyyy',this,true)"
      onmouseup="return false"
      ...
      <td id="td_cab_7" name="td_cab_7" width="140"><b>Manifiesto:</b>
      <input value="0" 
      onfocus="select();"
      onblur="Actualizar_Datos_Carpeta(this.name,this.value)"
      onmouseup="return false"
      ...
      <select OnChange="Actualizar_Datos_Carpeta(this.name,this.value)"
  ...
  <fieldset id="fieldset_gastos" name="fieldset_gastos" align="center" style="width:100%; height:378px; visibility: hidden;">
  ...
  <tr bgcolor="#DDDDDD">
    ...
    OnClick="Cancelar_Ingreso_Carpeta()" id="bot_cancelar_carpeta" name="bot_cancelar_carpeta">&nbsp;</td>
  </tr>
  </table>
</div>
<div id="capaFrame" name="capaFrame" style="position:absolute; width: 840px; height:220px; top: 180px; visibility:hidden;">
<iframe id="frameOcultar" name="frameOcultar" scrolling="no" frameborder="0" style="position:absolute; width: 600px; height:220px; border:none; display:block; z-index:-1;"></iframe>
</div>
