...
strSQL="select Numero_interno_documento_no_valorizado, numero_documento_no_valorizado, " &_
       "bodega, proveedor, fecha_recepcion = case when Fecha_recepcion is Null then convert( varchar(10), getdate(), 111 ) else Fecha_recepcion end, paridad_conversion_a_dolar " &_
       "from documentos_no_valorizados with(nolock) where empresa='SYS' and Carpeta like '%" & traspaso_anio & "%' and " &_
