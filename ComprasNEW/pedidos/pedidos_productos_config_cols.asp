...
if tcp_1 then
  ...
  col.align             = "left"
  col.width             = 80
  col.caption           = " DESPACHO"&chr(13)&"(1)"
  col.column_name       = "tcp_1"
  col.tipo              = "char"
  col.readonly          = true
  grid.add_col col
...
if tcp_2 then
  ...
  col.align             = "left"
  col.width             = 80
  col.caption           = " DESPACHO"&chr(13)&"(2)"
  col.column_name       = "tcp_2"
  col.tipo              = "char"
  col.readonly          = true
  grid.add_col col
...
if tcp_3 then
  ...
  col.align             = "left"
  col.width             = 80
  col.caption           = " DESPACHO"&chr(13)&"(3)"
  col.column_name       = "tcp_3"
  col.tipo              = "char"
  col.readonly          = true
  grid.add_col col
...
if tcp_4 then
  ...
  col.align             = "left"
  col.width             = 80
  col.caption           = " DESPACHO"&chr(13)&"(4)"
  col.column_name       = "tcp_4"
  col.tipo              = "char"
  col.readonly          = true
  grid.add_col col
...
if tcp_5 then
  ...
  col.align             = "left"
  col.width             = 80
  col.caption           = " DESPACHO"&chr(13)&"(5)"
  col.column_name       = "tcp_5"
  col.tipo              = "char"
  col.readonly          = true
  grid.add_col col
