...
<html>
	<head>
		<title>Ayuda Codigo De Documentos</title>
...
<script language="javascript"> 
    ...
    {
		var Error = "N"
		var Codigo = document.FormularioAyuda.Documento.value;
		...
		{
			if ( ! validEmpty(Nombre) )
			{
				if ( Nombre.length < 2 )
				{
					Error = "S";
					alert('La glosa debe contener al menos 2 caractéres.');
				}
			}
		}
...
<Form name="FormularioAyuda" method="post" action="List_AyudaDocumento.asp" target="wnd_abajo">
	<table align=center width=95% border=0 cellspacing=0 cellpadding=0>
		<tr>
			<td colspan=4 width=100% class="FuenteTitulosFunciones" align=center nowrap>Ayuda Codigo De Documentos</td>
		</tr>
		<tr>
			<td class="FuenteEncabezados" width=20% align=left ><b>Codigo</b></td>
			<td align=left>
				<input Class="FuenteInput" type=Text name="Documento" size=12 maxlength=12 value='' aonblur="javascript:validaCaractesPassWord(this.value , this)">
			</td>
		</tr>
		<tr>	
