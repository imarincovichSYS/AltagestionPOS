...
<script language="javascript"> 
     ...
     function fNuevo()
     {
		...
		var winURL  = "../../Mantenciones/EntidadesComerciales/Win_NuevaEntidad.asp?hora="+hora;
		var winName = "NuevaEntidad" ;
    ...
    function fBuscar()
    {
		...
		var Nombre = LTrim(RTrim(document.FormularioAyuda.Nombre.value));
...
<Form name="FormularioAyuda" method="post" action="List_AyudaClientes.asp?tipo=<%=request("tipo")%>" target="wnd_abajo">
	...
	<table align=center width=95% border=0 cellspacing=0 cellpadding=0>
		<tr>
			<td colspan=4 width=100% class="FuenteTitulosFunciones" align=center nowrap>Ayuda de entidades comerciales</td>
		</tr>
		<tr>
