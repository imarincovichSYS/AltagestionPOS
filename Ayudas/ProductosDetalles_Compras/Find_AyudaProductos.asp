...
<Form name="FormularioAyuda" method="post" action="List_AyudaProductos.asp" target="wnd_abajo">
	...
	<table align=center width=95% border=0 cellspacing=0 cellpadding=0>
		...
		<tr>
			<td nowrap colspan=4 class="FuenteInput" align=left>
				<input class="FuenteInput" type=radio name="ListaPrecio" value="S">Solo precio proveedor
				<input checked class="FuenteInput" type=radio name="ListaPrecio" value="N">Todos los productos
			</td>
		</tr>
	</table>
</Form>
