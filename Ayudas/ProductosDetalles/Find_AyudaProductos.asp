...
<script language="javascript"> 
    ...
    {
		var Error = "N"
		var SuperFam	= document.FormularioAyuda.Slct_SuperFam.value;
		var Familia		= document.FormularioAyuda.Slct_Familia.value;
		var SubFamilia	= document.FormularioAyuda.Slct_SubFamilia.value;
		
		var Descripcion = LTrim(RTrim(document.FormularioAyuda.Descripcion.value));
		
		if ( validEmpty(SuperFam) && validEmpty(Familia) && validEmpty(SubFamilia) && validEmpty(Descripcion) )
		{
			Error = "S"
