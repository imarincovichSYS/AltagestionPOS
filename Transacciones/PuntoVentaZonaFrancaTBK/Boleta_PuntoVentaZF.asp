...
<html>
   ...
   <body bgcolor="" leftmargin="0" topmargin="0" text="#000000">
      ...
      <div id="dialog-confirm" title="Opciones Transbank" style="display:none;">
         <ul class="FuenteEncabezados">
            <p><li><a href="javascript:jsUltima_venta();" style="text-decoration:none;">Transacci&oacute;n &uacute;ltima venta</a></li></p>
            <p><li><a href="javascript:jsTotales();" style="text-decoration:none;">Transacci&oacute;n totales</a></li></p>
            <p><li><a href="javascript:jsDetalle_de_Ventas();" style="text-decoration:none;">Transacci&oacute;n de detalle de ventas</a></li></p>
            <p><li><a href="javascript:jsPoll();" style="text-decoration:none;">Transacci&oacute;n de poll</a></li></p>
            <p><li><a href="javascript:jsCambio_a_POS_Normal();" style="text-decoration:none;">Transacci&oacute;n de cambio a POS normal</a></li></p>
            <p><li><span id="loading" style="display:none;"><img src="../../Imagenes/loader.gif">&nbsp;&nbsp;</span><strong>Estado</strong><Br />
            <textarea name="showInfo" id="showInfo" cols="60" rows="4" readonly="readonly" style="resize: none;"></textarea>
            </li></p>
         </ul>
      </div>	
   </body>
...
<script language="JavaScript">
   ...
   function jsUltima_venta() {
      ...
      jsTBKTransaccion(InfoToSend, function(err, result) {
         if (err) {
            $("#showInfo").val(err.Mensaje);
         }
         else {
            $("#showInfo").val(result.DataResponse);
         }
         $("#loading").hide();
      },true);
   }
