            ...
            if "<% = es_mueble %>" = "S" then
                ...
                if "<% = es_cabina %>" = "S" then
                    ...
                    if "<% = LineaImpuestoILA %>" <> "" then
                        ...
                        if "<% = es_sorteo %>" = "S" then
                          mtxDetalle(a+n+13) = "116         SORTEO 80 AÑOS (<%=Cantidad_cupones%> <%=strCupones%>)"
                      ...
                      if "<% = es_sorteo %>" = "S" then
                        mtxDetalle(a+n+12) = "116         SORTEO 80 AÑOS (<%=Cantidad_cupones%> <%=strCupones%>)"
                    ...
                    if "<% = LineaImpuestoILA %>" <> "" then
                      if "<% = es_sorteo %>" = "S" then
                        ...
                        mtxDetalle(a+n+11) = "116         SORTEO 80 AÑOS (<%=Cantidad_cupones%> <%=strCupones%>)"
                      ...
                      if "<% = es_sorteo %>" = "S" then
                        mtxDetalle(a+n+10) = "116         SORTEO 80 AÑOS (<%=Cantidad_cupones%> <%=strCupones%>)"
                ...
                if "<% = LineaImpuestoILA %>" <> "" then
                  ...
                  if "<% = es_sorteo %>" = "S" then
                    mtxDetalle(a+n+9) = "116          SORTEO 80 AÑOS (<%=Cantidad_cupones%> <%=strCupones%>)"
