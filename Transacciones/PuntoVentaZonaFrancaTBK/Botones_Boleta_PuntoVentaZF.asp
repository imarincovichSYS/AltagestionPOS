   ...
   <html>
      <head>
         ...
         <script language="JavaScript">
            ...
            function Opciones()
            {
               //parent.top.frames[1].jsShowTBKAcciones();
               var sValue = window.showModalDialog ("Botones_transbank.asp", "valor", "dialogWidth:25;dialogHeight:10;center:yes;edge:sunken;unadorned:yes;status:no;help:no;")
            }
         </script>
      </head>
      <body bgcolor="<%=Session("ColorFondo")%>" leftmargin=0 topmargin=0 text="#000000" background="../../<%=Session("ImagenFondo")%>">
         <table width=100% border=0 cellspacing=0 cellpadding=0>
            <tr>
               ...
               <td align="center">
                  <b><a class="FuenteBotonesLink" href="JavaScript:Opciones()">Opciones transbank</a></b>				
               </td> 
            </tr>
         </table>
      </body>
