...
<html>
	...
	<frameset rows="25%,*" frameborder='0' framespacing='0' border='0'>
		<frame frameborder=0 marginwidth=0 marginheight=0 framespacing='0' src='Find_Reimpresion.asp?Orden=<%=Request("Orden")%>&pagenum=<%=Request("pagenum")%>'	scrolling=no	name="Busqueda"></frame>
