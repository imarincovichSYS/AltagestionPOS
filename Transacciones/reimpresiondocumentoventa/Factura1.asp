...
'Response.Write cSql_D & "<br>"
    ...
    Cabecera = Cabecera & TxtPrint( space(10) ) & chr(13)		  
	  Cabecera = Cabecera & TxtPrint( chr(15) & space(7) & Senores & space(40-len(Left(Senores,40))) & space(12) & LTRIM(RTRIM(Direccion)) & Space(26-len(Left(Direccion,26))) & space(15) & Rut_Cliente & space(10-len(Rut_Cliente)) )	& chr(13)	& chr(13) & chr(13)' Dirección - Vendedor - Fecha
