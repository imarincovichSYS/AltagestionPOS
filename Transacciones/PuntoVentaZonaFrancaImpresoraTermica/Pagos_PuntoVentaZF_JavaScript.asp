<script language="JavaScript">
    ...
    function Descuentos()
    {
      //Se saco la condici�n que pida autorizaci�n supervisor s�lo en L02-->Debe ser siempre (L01 y L02). Actualizaci�n: cmartinez 2013-10-11 14:30:00
      //if ( ('<%=Session("Login")%>' != '13884785' && '<%=Session("Login")%>' != '15308847' && '<%=Session("Login")%>' != '15309968' && '<%=Session("Login")%>' != '17238275' && '<%=Session("Login")%>' != '15923212' && '<%=Session("Login")%>' != '13859206' && '<%=Session("Login")%>' != '17629393' && '<%=Session("Login")%>' != '17587517' && '<%=Session("Login")%>' != '9926612' && '<%=Session("Login")%>' != '19424203') && '<%=Session("Muestra_descuentos")%>' == 'No')
      if ( ('<%=Session("Login")%>' != '15906028' && '<%=Session("Login")%>' != '15308847' && '<%=Session("Login")%>' != '15309968' && '<%=Session("Login")%>' != '9718422' && '<%=Session("Login")%>' != '15923212' && '<%=Session("Login")%>' != '17893185' && '<%=Session("Login")%>' != '13971954' && '<%=Session("Login")%>' != '17387039' ) && '<%=Session("Muestra_descuentos")%>' == 'No')
      {
          var sValue = undefined;        
          do
          {
...
document.formulario.submit();
    ...
    if ( onsubmit == "No" ) 
    {
        if ( TeclaPresionada == 113   ) // Control cajon
		{  
            MyFunction();
		}
...
function Valida_Caracteres_Fecha(e){
 ...
 <script language="VbScript">
    sub VBFuncCajon()
        ...
        url = "http://localhost:8080/phpcaja/docs/pulse.php"
