...
<tr bgcolor="<%=ColorLinea%>" class="FuenteInput">
   ...
   <td>&nbsp;
       <select class="FuenteInput" name="Tipo_documento_cobro_<%=n%>" style="width:150" Onchange="if( this.value == 'UEI;0;0;' ) { document.getElementById('Monto_documento_cobro_<%=n%>').value = 0;    };javascript:fVerificaDoc(this)" qonchange="submitform()">
