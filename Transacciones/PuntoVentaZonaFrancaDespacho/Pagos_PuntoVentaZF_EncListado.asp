...
<div style="position:absolute; top:292px; left:<%=256-delta%>px; z-index:1" style="font-size: 14px; font-family: sans-serif;font-weight: bold; line-height: 150%;"> 
     Descto. Gral. <input onkeypress="return Valida_Descuento(event);"
     id="Descuento_documento" type="text" name="Descuento_documento" size="4" maxlength="5" value="<%=Descuento_documento%>" style="background-color:#ffffff; color=#000000; font-size: 12px;" onchange="submitform()">
</div>
<%end if%>
