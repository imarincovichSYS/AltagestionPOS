...
<html>
	...
	<frameset rows="35%,*" frameborder='0' framespacing='0' border='0'>
		<frame frameborder=0 marginwidth=0 marginheight=0 framespacing='0' src="Find_Empresas.asp"	scrolling=no	name="Busqueda"></frame>
		<frame frameborder=0 marginwidth=0 marginheight=0 framespacing='0' src='List_Empresas.asp?Empresa=<%=session("Empresa")%>&Nombre=<%=session("Nombre")%>&Orden=<%=Request("Orden")%>&pagenum=<%=session("pagenum")%>' scrolling=auto	name="Listado"></frame>
	</frameset>
	<noframes>
