...
if Request("Accion") = "Consulta" then
   ...
   if Conn.Errors.Count = 0 then
      ...
      strSQL="select valor_unitario, limite_precio from productos_en_listas_de_precios " &_
	           "where empresa='SYS' and producto='"&Codigo_producto&"' " &_
	           "and lista_de_precios='LXMAY' and limite_precio>0 " &_
	           "and (select temporada from productos where empresa='SYS' and producto = '"&Codigo_producto&"') in ('XMAY','PATG','NOV','CHAO')"
