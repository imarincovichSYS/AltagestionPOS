...
sub borrar_boleta_fantasma_sys(Sql)
    set Conector = server.createobject("ADODB.Connection")
    Conector.open session("DataConn_ConnectionString")
    Conector.CommandTimeout = 3600
...
'function Get_Porcentaje_Descuento_Producto_X_Economato(v_economato,v_superfamilia,v_familia,v_subfamilia,v_marca) 
 'strSQL="select resultado = (case when IsNull((select porcentaje_descuento resultado from economatos_descuentos where economato = '"&v_economato&"' and superfamilia='"&v_superfamilia&"' and familia='"&v_familia&"' and subfamilia='"&v_subfamilia&"' and marca='"&v_marca&"'), 0) <> 0 then " &_
 '" IsNull((select porcentaje_descuento resultado from economatos_descuentos where economato = '"&v_economato&"' and superfamilia='"&v_superfamilia&"' and familia='"&v_familia&"' and subfamilia='"&v_subfamilia&"' and marca='"&v_marca&"'), 0) " &_
'" Else " &_
 '" case when IsNull((select porcentaje_descuento resultado from economatos_descuentos where economato = '"&v_economato&"' and superfamilia='"&v_superfamilia&"' and familia='"&v_familia&"' and subfamilia='"&v_subfamilia&"'), 0) <> 0 then " &_
 ' " IsNull((select porcentaje_descuento resultado from economatos_descuentos where economato = '"&v_economato&"' and superfamilia='"&v_superfamilia&"' and familia='"&v_familia&"' and subfamilia='"&v_subfamilia&"'), 0) " &_
 '" else " &_
  '" case when IsNull((select porcentaje_descuento resultado from economatos_descuentos where economato = '"&v_economato&"' and superfamilia='"&v_superfamilia&"' and familia='"&v_familia&"'), 0) <> 0 then " &_
   '" IsNull((select porcentaje_descuento resultado from economatos_descuentos where economato = '"&v_economato&"' and superfamilia='"&v_superfamilia&"' and familia='"&v_familia&"'), 0) " &_
  '" else " &_
   '" case when IsNull((select porcentaje_descuento resultado from economatos_descuentos where economato = '"&v_economato&"' and superfamilia='"&v_superfamilia&"'), 0) <> 0 then " &_
    '" IsNull((select porcentaje_descuento resultado from economatos_descuentos where economato = '"&v_economato&"' and superfamilia='"&v_superfamilia&"'), 0) " &_
   '" else " &_
    '" 0 " &_
   '" end " &_
  '" end " &_
...
function Get_Porcentaje_Descuento_Producto_X_Economato(v_economato,v_superfamilia, v_familia, v_subfamilia, v_marca) 
  strSQL="select porcentaje_descuento resultado from economatos_descuentos with(nolock) " &_					
         ...
         "superfamilia='"&v_superfamilia&"' and familia='"&v_familia&"' and subfamilia='"&v_subfamilia&"' and marca='"&v_marca&"' "										
  'Response.Write strSQL
  'Response.End
    set rs_get = Conn.Execute(strSQL) : resultado = 0
	if not rs_get.EOF then resultado = rs_get("resultado")														
