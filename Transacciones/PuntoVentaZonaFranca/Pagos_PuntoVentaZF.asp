...
IF Session("flagFechaBoleta") Then
	...
	Set Rs = Conn.Execute("EXEC DCA_RescataUltimoDolarCambio '" & FechaBoleta & "'")
ELSE
...
if total_productos = 1 and (temporada="XMAY" or temporada="PATG" or temporada="NOV" or temporada="CHAO" or temporada="500AÑOS" ) then Admite_descuento = false 
...
Total_dolares = CInt(Cdbl(Total_pesos / DolarCambioSupervisoraCajas) + 0.5)
'Total_dolares = Round(Total_pesos / DolarCambioSupervisoraCajas)
'***************************************************
'---------------- Cabecera   -----------------------
