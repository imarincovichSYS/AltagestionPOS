...
function Editar_Carpeta(){
  if(Radio_Es_Arreglo(radio_carpetas))
  {
    for(i=0;i<=radio_carpetas.length-1;i++)
      ...
      { 
        ...
        v_fecha_llegada       = radio_carpetas[i].fecha_llegada
        v_manifiesto          = radio_carpetas[i].manifiesto
        break;
      }
  }
  else
  {
    ...
    v_fecha_llegada       = radio_carpetas.fecha_llegada
    v_manifiesto          = radio_carpetas.manifiesto
  }
