...
<Form name="FormularioAyuda" method="post" action="List_AyudaProductos.asp" target="wnd_abajo">
	...
	<table align=center width=95% border=0 cellspacing=0 cellpadding=0>
      ...
      <td rowspan = 7 align=center width=10%>            
        <%cSql = "Select distinct folio_cambio_de_precio from cambios_de_precios where fecha>=convert(varchar(12),getdate(),112) and origen = 'Normales' order by folio_cambio_de_precio desc"
        ...
        <select class="FuenteInput" name="FuncionesSiIncluidas" size=7  style="width:80%" ondblclick="JavaScript:precios()">     
          ...
          loop %>
			...
			<tr>
		<tr>
			<td colspan=4 width=100% class="FuenteTitulosFunciones" align=center nowrap>Imprime Precios Ashley</td>
		</tr>		


    <tr>
		  <td width=10% class="FuenteEncabezados" align=left nowrap>Producto</td>
		  <td>  <input class="FuenteInput" type=text name="producto" value="<%=producto%>" size=16 maxlength=9> </td>
