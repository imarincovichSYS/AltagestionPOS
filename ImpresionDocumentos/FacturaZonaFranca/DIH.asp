...
'Response.Write cSql_C & "<br>"
  ...
  ''     Normal = chr(27) & chr(54) & chr(18) & chr(27) & chr(58)
   '' elseif Marca_impresora = "EPSON" then
    ...
    Cabecera = Largo_78 & Normal & CrLf & CrLf & CrLf

    Cabecera = Cabecera & space(45) &    "SOLICITUD DESCARGA INVENTARIO                         "
   ...
   Cabecera = Cabecera & space(32) & padR(Aduana_presentacion_OrdenVtaSUP,26) & space(5) & Codigo_aduana_presentacion_OrdenVtaSUP & "     EXTRANJERA              1"  & Crlf & Crlf
   Cabecera = Cabecera & space(32) & padR(Persona_que_presenta_OrdenVtaSUP,26)

   Cabecera = Cabecera + "             DOLARES                02" & Crlf & Crlf 

   Cabecera = Cabecera & space(68) & PadR(NombreBodega,22) & space(3) & PadR(Bodega,3) & Crlf & CrLf & CrLf
   Cabecera = Cabecera & space(68) & PadR(NombreBodega,22) & space(3) & PadR(Bodega,3) & Crlf

   Cabecera = Cabecera & Crlf & Crlf 

   Cabecera = Cabecera & space(4) & PadR(Nombre_empresa,46) & Rut_empresa & Crlf  & Crlf
   Cabecera = Cabecera & space(14) & comprimida & "MANZANA 7 Z.FRANCA" & space(35) & "T-217 21/07/2017" & CrLf
...
'Response.Write cSql_D & "<br>"
	...
	Do While Not RsD.Eof
     ...
     Total = Cif
	   Factura = Factura & comprimida & space(5) & strzero(n,2) & "  " & _
               PadL(FormatNumber(Cantidad,2),9) & space(9) & _
               PadR(RsD("Unidad_de_medida_consumo"),3) & space(3) & _
               siglaunidad & space(2) & _
               PadR( RsD("Descripcion_50") , 47 ) & "  " & _
               ...
               PadL( FormatNumber(Precio,4) , 7 ) & _
               PadL( FormatNumber(Total,2) , 20 ) & CrLf
     n = n + 1
     nl = nl + 1
  ...
  For n = nl to (Lineas_detalle - 3)
      	Factura = Factura & Crlf      
  Next
  Factura = Factura & space(40) & " GARANTIA N470 AÑO 2021" 		& Crlf
  Factura = Factura & Crlf
  Factura = Factura & Crlf  

  'Totales finales
  Factura = Factura &  "     MERCANCIA REBAJADA DE INVENTARIO POR HURTO O CONSUMO EN LOCAL, SIN PERJUICIO " & space( 115 - 80 ) & _
            PadL( FormatNumber(Total_cif_US,2) , 18 ) 
  Factura = Factura & "      DE ENTRAR EN ARCAS FISCALES EL CORRESPONDIENTE IMPUESTO CONFORME AL ARTICULO 11 " & CrLf &_ 
            "     LEY 18211." & CrLf  &  space( 115 ) & _
            PadL( FormatNumber(Total_cif_US,2) , 18 )
