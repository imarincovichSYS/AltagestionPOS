...
'Response.write( cSql_C & "<br>" )
	SET RsC	=	Conn.Execute( cSql_C )
		...
		Senores				= cambia_chr( RsC("Nombre_Cliente") )
			...
			Rut_Cliente	= "DNI " & RsC("Rut_Cliente") '& "-" & cStr(Digito)
    ...
    Factura = Factura & space(25) & "SOLICITUD DE REEXPEDICION FACTURA    R          " & Fecha & Crlf
...
'Response.write( cSql_D & "<br>" )
  ...
  For n = nl to 27 'Aquí dejar en 30 para hoja real
      Factura = Factura & Crlf
  Next

  'Resumen Impuestos
  Factura = Factura & _
            space(40) & "CIF TOTAL US$: " & Formato(Total_cif_US,2) & CrLf & _
            space(40) & "TOTAL " & Formato(Total_dolares,2) & CrLf & CrLf & CrLf & CrLf & CrLf & CrLf & CrLf & CrLf
