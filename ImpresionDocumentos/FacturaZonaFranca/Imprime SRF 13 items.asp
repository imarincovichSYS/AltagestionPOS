...
<%
  ...
  Total_cif_US = 0
	Do While Not RsD.Eof
     ...
     Factura = Factura & space(21) & _
               "CIF Uni US$  " & Formato(RsD("Costo_cif_ori_US$_2_decimales"),2) & _
  ...
  'Resumen Impuestos
  Factura = Factura & _
            space(30) & "IMPUESTO 0.6% US$: " & Formato(Total_impuesto_US,2) & CrLf & _
            space(30) & "T/C AL " & Fecha & " $ " & Formato(Tipo_cambio,2) & CrLf & _
            space(30) & "IMPUESTO 0.6 % M/N: $ " & Formato(Total_impuesto_pesos,2) & CrLf & CrLf & CrLf

  'Totales finales
  Factura = Factura & space( 66 ) & _
            PadL( Formato(Total_impuesto_US,2) , 12 ) & _
            PadL( Formato(Total_pesos,0) , 12 ) & CrLf & CrLf & CrLf & CrLf & CrLf & CrLf & CrLf
  Factura = Factura & space( 78 ) & _
            PadL( Formato(Total_pesos,0) , 12 )
