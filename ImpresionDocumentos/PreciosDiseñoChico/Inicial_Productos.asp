...
<html>
	...
	<frameset rows="10%,*" frameborder='0' framespacing='0' border='0'>
		<frame frameborder=0 marginwidth=0 marginheight=0 framespacing='0' src='Find_Productos.asp?Orden=<%=Request("Orden")%>&pagenum=<%=Request("pagenum")%>'	scrolling=no	name="Busqueda"></frame>
		<frame frameborder=0 marginwidth=0 marginheight=0 framespacing='0' src='../../Empty.asp' scrolling=no	name="Listado"></frame>
	</frameset>
	<noframes>
