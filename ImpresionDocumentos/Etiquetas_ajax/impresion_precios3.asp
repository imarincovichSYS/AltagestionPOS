	...
	<script type="text/javascript">
		...
		function zebra(tipo_precio, precio, cod_producto, desc_prod, oferta){
			if(tipo_precio == "fleje"){
				...
				document.jzebra.findPrinter(printers[0]); /*busco la impresora por nombre*/
			...
			if(tipo_precio=="gancho"){
				...
				document.jzebra.findPrinter(printers[1]); /*busco la impresora por nombre*/
				document.jzebra.append(etiquetas);  /*coloco variable a imprimir*/ 
			...
			if(tipo_precio=="grande"){
				...
				document.jzebra.findPrinter(printers[2]); /*busco la impresora por nombre*/
				document.jzebra.append(etiquetas);  /*coloco variable a imprimir*/ 
				document.jzebra.print();	
			}			
		}
