      ...
      IF Request("oferta_"&i)<>"on" then 'EL PRECIO ES FLEJE NORMAL
        ...
        for cant=1 to Request("Cant_"&i)
          if Request("Precio_"&i) >= 100000 then      
            ...
            "^FO580,170^ARN,2,2^FD" & Request("Producto_"&i) & "^FS" & _
			  "^FO230,170^ARN,2,2^FD" & Request("Marca_"&i)  & "^FS" & _  
              "^FO180,220^A0,20,20^FD" & Request("Desc_"&i) & "^FS"  
              ...
              if Request("grs_"&i) > 0 then 
                   Etiqueta = Etiqueta & "^FO390,265^A0,20,20^FD Pr.xKilo " & formatNumber((Request("Precio_"&i)*1000)/Request("grs_"&i),0) & "^FS"
              elseif Request("cc_"&i) > 0 then
                   Etiqueta = Etiqueta & "^FO390,265^A0,20,20^FD Pr.xLitro " & formatNumber((Request("Precio_"&i)*1000)/Request("cc_"&i),0) & "^FS"
              end if
          ...
          elseif Request("Precio_"&i) < 1000 then
           ...
           "^FO630,170^ARN,2,2^FD" & Request("Producto_"&i) & "^FS" & _
			  "^FO280,170^ARN,2,2^FD" & Request("Marca_"&i)  & "^FS" & _  
              "^FO220,220^A0,20,20^FD" & Request("Desc_"&i) & "^FS" 
          ...
          elseif Request("Precio_"&i) >= 1000 and  Request("Precio_"&i) < 10000 then      
           ...
           "^FO580,170^ARN,2,2^FD" & Request("Producto_"&i) & "^FS" & _
              ...
              if Request("grs_"&i) > 0 then 
                   Etiqueta = Etiqueta & "^FO355,265^A0,20,20^FD Pr.xKilo " & formatNumber((Request("Precio_"&i)*1000)/Request("grs_"&i),0) & "^FS"
              elseif Request("cc_"&i) > 0 then
                   Etiqueta = Etiqueta & "^FO355,265^A0,20,20^FD Pr.xLitro " & formatNumber((Request("Precio_"&i)*1000)/Request("cc_"&i),0) & "^FS"
              end if
              Etiqueta = Etiqueta & "^XZ" 
          else
              ...
              "^FO180,220^A0,20,20^FD" & Request("Desc_"&i) & "^FS" 
              if Request("PMay_"&i) >0 then
                  Etiqueta = Etiqueta & "^FO710,260^A0,25,25^FD" & formatNumber(Request("PMay_"&i),0) & "^FS"
      ...
      ELSE 'EL PRECIO ES FLEJE OFERTA
        ...
        for cant=1 to Request("Cant_"&i)
          if Request("Prom_"&i) >= 100000 then      
             ...
             "^FO500,170^ARN,2,2^FD" & Request("Producto_"&i) & "^FS" & _
			  "^FO210,170^ARN,2,2^FD" & Request("Marca_"&i)  & "^FS" & _  
              "^FO180,220^A0,20,20^FD" & Request("Desc_"&i) & "^FS" 
              if Request("PMay_"&i) >0 then
      ...
      if Request("oferta_"&i)<>"on" then 'ES GANCHO NORMAL
		...
		Linea1 = trim(left(request("Desc_"&i),25))
          ...
          if Request("Precio_"&i) >= 10000 then
              ...
              "^FO40,140^ARN,2,2^FD" & Request("Marca_"&i) & "^FS" & _
			  "^FO270,140^ARN,2,2^FD" & Request("Producto_"&i)  & "^FS" & _  
             "^FO80,190^A0,20,20^FD" & Linea1 & "^FS" & _
              "^FO80,215^A0,20,20^FD" & Linea2 & "^FS" 
              if Request("grs_"&i) > 0 then 
                   Etiqueta3 = Etiqueta3 & "^FO170,235^A0,17,17^FD Pr.xKilo " & formatNumber((Request("Precio_"&i)*1000)/Request("grs_"&i),0) & "^FS"
              elseif Request("cc_"&i) > 0 then
                   Etiqueta3 = Etiqueta3 & "^FO170,235^A0,17,17^FD Pr.xLitro " & formatNumber((Request("Precio_"&i)*1000)/Request("cc_"&i),0) & "^FS"
              end if
        ...
        for cant=1 to Request("Cant_"&i)
          ...
          if Request("Prom_"&i) >= 10000 then
             ...
             "^FO80,190^A0,20,20^FD" & Linea1 & "^FS" & _
              "^FO80,215^A0,20,20^FD" & Linea2 & "^FS" 
              if Request("grs_"&i) > 0 then 
                   Etiqueta2 = Etiqueta2 & "^FO170,235^A0,17,17^FD Pr.xKilo " & formatNumber((Request("Prom_"&i)*1000)/Request("grs_"&i),0) & "^FS"
              elseif Request("cc_"&i) > 0 then
                   Etiqueta2 = Etiqueta2 & "^FO170,235^A0,17,17^FD Pr.xLitro " & formatNumber((Request("Prom_"&i)*1000)/Request("cc_"&i),0) & "^FS"
              end if
              Etiqueta2 = Etiqueta2 & "^XZ"
          elseif Request("Prom_"&i) < 1000 then
             ...
             "^FO80,190^A0,20,20^FD" & Linea1 & "^FS" & _
              "^FO80,215^A0,20,20^FD" & Linea2 & "^FS" 
              if Request("grs_"&i) > 0 then 
                   Etiqueta2 = Etiqueta2 & "^F170,235^A0,17,17^FD Pr.xKilo " & formatNumber((Request("Prom_"&i)*1000)/Request("grs_"&i),0) & "^FS"
              elseif Request("cc_"&i) > 0 then
                   Etiqueta2 = Etiqueta2 & "^FO170,235^A0,17,17^FD Pr.xLitro " & formatNumber((Request("Prom_"&i)*1000)/Request("cc_"&i),0) & "^FS"
              end if
              Etiqueta2 = Etiqueta2 & "^XZ"          
