...
strConnect_Alta     = "driver={SQL Server};Server=sqlsanchez;Database=sanchez;UID=SYSGestion;PWD=bGw5NgJwb3;User Id=SYSGestion;Password=bGw5NgJwb3; Trusted_Connections=yes;"
...
'strConnect_Alta     = "DSN="&Nombre_DSN&";UID=AG_Sanchez;PWD=;APP=BackOffice;WSID=" & Request.ServerVariables( "REMOTE_ADDR" ) & ";DATABASE=Sanchez"id=SYSGestion;password=bGw5NgJwb3;
