...
<Form name="FormularioAyuda" method="post" action="List_AyudaProductos.asp" target="wnd_abajo">
	...
	<table align=center width=95% border=0 cellspacing=0 cellpadding=0>
		<tr>
			<td colspan=4 width=100% class="FuenteTitulosFunciones" align=center nowrap>Pedido</td>
		</tr>
     ...
     <tr>
      ...
      <td><td class="FuenteTitulosFunciones" align=left>
...
<!-- <td nowrap class="FuenteEncabezados" width=10% align=left >Bodega&nbsp;</td>
					<td align=left>
						 <select Class="FuenteInput" style="width:150" name="Bodega">
							...
							<option value="0011-Manzana 7">Manzana 7</option>	
		...
		-->
		<input type=hidden name="Bodega" value="<%=Codigo_Postal%>">
