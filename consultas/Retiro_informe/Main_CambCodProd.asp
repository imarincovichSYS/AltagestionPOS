...
<html>
  <body qonload="javascript:{if(parent.top.frames[0]&&parent.top.frames['Menu'].Go)parent.top.frames['Menu'].Go()}">
	<script language="JavaScript">
		parent.Botones.location.href = "Botones_CambCodProd.asp?nomina=N"
		parent.Trabajo.location.href = 'Inicial_CambCodProd.asp?Orden=<%=Request("Orden")%>&pagenum=<%=Request("pagenum")%>'
