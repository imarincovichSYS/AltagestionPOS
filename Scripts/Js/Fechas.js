...
{
        var fechadesde = new Date(desde.substring(6,10),
                            desde.substring(3,5)-1,
                            desde.substring(0,2));
        var fechahasta = new Date(hasta.substring(6,10),
                            hasta.substring(3,5)-1,
                            hasta.substring(0,2));
...
function ValidarHora ( hora )
{
	...
	{
		zError = "S"
		return ( "Introdujo una cadena mayor a 5 caracteres" )
	}
	if (hora.length != 5) 
	{
		zError = "S"
		return ( "Formato de hora debe ser HH:MM" )
	}
	ha=hora.charAt(0) //<=2
	hb=hora.charAt(1) //<4
	hc=hora.charAt(2) //:
	...
	if ( ! validaNumeros(ha) || ! validaNumeros(hb) )
	{
		zError = "S"
		return ( "El valor que introdujo en la Hora no corresponde, introduzca un digito entre 00 y 23" );
	}	

	if ( ! validaNumeros(hd) || ! validaNumeros(hd1) )
	{
		zError = "S"
		return ( "El valor que introdujo en los minutos no corresponde, introduzca un digito entre 00 y 59" );
	}	
	...
	{
		zError = "S"
		return ( "Introduzca el caracter ':' para separar la hora de los minutos." );
	}
	if ( zError == "N" )
	{	
		return ( "OK" )
