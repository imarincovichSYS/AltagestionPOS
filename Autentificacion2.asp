...
if Instr(1,Request.ServerVariables( "HTTP_USER_AGENT" ),"PPC;") > 0 Then
	...
	session("DataConn_ConnectionTimeout")	= 90
	...
	'Session("ConexionInicial") = "DSN=AG_Sanchez;UID=AG_Sanchez;PWD=Vp?T+!mZpJds;APP=BackOffice;WSID=" & Request.ServerVariables( "REMOTE_ADDR" ) & ";DATABASE=Sanchez"
	'Session("DataConn_ConnectionString") = "DSN=AG_Sanchez;UID=AG_Sanchez;PWD=Vp?T+!mZpJds;APP=BackOffice;WSID=" & Request.ServerVariables( "REMOTE_ADDR" ) & ";DATABASE=Sanchez"
