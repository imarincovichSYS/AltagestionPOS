...
<html>
  <body >
	<script language="JavaScript">
		parent.Botones.location.href = "Botones_ProdLstaProv.asp"
		parent.Trabajo.location.href = 'Inicial_ProdLstaProv.asp?Orden=<%=Request("Orden")%>&pagenum=<%=Request("pagenum")%>'
