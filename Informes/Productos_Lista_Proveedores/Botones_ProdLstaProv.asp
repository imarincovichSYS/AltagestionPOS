...
<script language="JavaScript">
	...
	function Buscar()
	{
		...
		if ( Error == "N" )
		{
			...
			if ( Salida == "P" )
			{
				parent.top.frames[1][0].document.Formulario.action = "List_ProdLstaProv.asp";
	...
	<Form name="Formulario_Botones" method="post" action="Mant_ProdLstaProv.asp" target="Trabajo">
