...
<html>
  <body qonload="javascript:{if(parent.top.frames[0]&&parent.top.frames['Menu'].Go)parent.top.frames['Menu'].Go()}">
	<script language="JavaScript">
		parent.Botones.location.href = "Botones_ControlVouch.asp"
		parent.Trabajo.location.href = 'Inicial_ControlVouch.asp?Orden=<%=Request("Orden")%>&pagenum=<%=Request("pagenum")%>'
